...
sp_constant_buffer_handle sp_constant_buffer_create(const char* name, const sp_constant_buffer_desc& desc)
{
	...
	_sp._device->CreateConstantBufferView(&constant_buffer_view_desc, _sp._shader_resource_view_cpu_descriptor_handle); // XXX: The SRV heap is also good for CBV and UAV
	buffer._constant_buffer_view = _sp._shader_resource_view_cpu_descriptor_handle;
