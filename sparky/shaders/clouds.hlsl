...
float4 ps_main(ps_input input) : SV_Target0
{
	...
	if (debug_raymarch_termination && debug_raymarch_termination_result != 0)
	{
		if (debug_raymarch_termination_result == 1) return float4(1.0, 0.0, 0.0, 1.0);
		else if (debug_raymarch_termination_result == 2) return float4(0.0, 1.0, 0.0, 1.0);
		else if (debug_raymarch_termination_result == 3) return float4(1.0, 0.0, 1.0, 1.0);
