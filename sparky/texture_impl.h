...
namespace detail
{
	...
	void sp_texture_defaults_create()
	{
		...
		defaults::white = sp_texture_create("default_white", { 2, 2, sp_texture_format::r8g8b8a8 });
		...
		defaults::black = sp_texture_create("default_black", { 2, 2, sp_texture_format::r8g8b8a8 });
		...
		defaults::checkerboard = sp_texture_create("default_checkerboard", { 8, 8, sp_texture_format::r8g8b8a8 });
